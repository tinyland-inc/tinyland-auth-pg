...
export const totpSecrets = authSchema.table('totp_secrets', {
...
export const backupCodes = authSchema.table('backup_codes', {
...
export const auditEvents = authSchema.table('audit_events', {
